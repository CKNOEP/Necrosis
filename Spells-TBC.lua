--[[
    Necrosis - TBC Classic (Burning Crusade) Edition
    Copyright (C) - copyright file included in this release

    This file contains spell definitions specific to TBC Classic (Interface 20500-20504)
    Based on Spells-Vanilla.lua with TBC-specific additions and spell updates
--]]
...
--]]
	...
	-- ::: TBC Specific Spells
	-- Seed of Corruption (TBC Affliction AoE DoT)
	[27243] = {UsageRank = 1, SpellRank = 1, Timer = true, Usage = "seed_of_corruption", Length = 18, }, -- Seed of Corruption R1 (TBC)
	[47835] = {UsageRank = 2, SpellRank = 2, Timer = true, Usage = "seed_of_corruption", Length = 18, }, -- Seed of Corruption R2 (WotLK)
	[47836] = {UsageRank = 3, SpellRank = 3, Timer = true, Usage = "seed_of_corruption", Length = 18, }, -- Seed of Corruption R3 (WotLK)

	-- Incinerate (TBC Destruction spell)
	[29722] = {UsageRank = 1, SpellRank = 1, Timer = false, Usage = "incinerate"}, -- Incinerate R1 (TBC)
	[32231] = {UsageRank = 2, SpellRank = 2, Timer = false, Usage = "incinerate"}, -- Incinerate R2 (TBC)
	[47837] = {UsageRank = 3, SpellRank = 3, Timer = false, Usage = "incinerate"}, -- Incinerate R3 (WotLK)
	[47838] = {UsageRank = 4, SpellRank = 4, Timer = false, Usage = "incinerate"}, -- Incinerate R4 (WotLK)

	-- Shadowfury (TBC Destruction AoE stun)
	[30283] = {UsageRank = 1, SpellRank = 1, Timer = false, Usage = "shadowfury", Cooldown = 20}, -- Shadowfury R1 (TBC)
	[30413] = {UsageRank = 2, SpellRank = 2, Timer = false, Usage = "shadowfury", Cooldown = 20}, -- Shadowfury R2 (TBC)
	[30414] = {UsageRank = 3, SpellRank = 3, Timer = false, Usage = "shadowfury", Cooldown = 20}, -- Shadowfury R3 (TBC)
	[47846] = {UsageRank = 4, SpellRank = 4, Timer = false, Usage = "shadowfury", Cooldown = 20}, -- Shadowfury R4 (WotLK)
	[47847] = {UsageRank = 5, SpellRank = 5, Timer = false, Usage = "shadowfury", Cooldown = 20}, -- Shadowfury R5 (WotLK)
