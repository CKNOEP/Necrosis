...
local _G, NUI, Lib, StdUi = _G, NUI, NUI.Lib, NUI.StdUi
local module = NUI:NewModule('Handler_Skinning')
	...
	RegisterAsContainer = function(self, widget)
		...
		elseif widgetType == 'Frame' then
			...
			if not frame.AppBar then
				...
				NUI:FormatFont(widget.titletext, 13)
...
NUI.callbacks = LibStub('CallbackHandler-1.0'):New(NUI)
NUI:RegisterCallback('Ace3', attemptSkin)
