...
function Necrosis:SetButtonsConfig()
	...
	if not frame then
		...
		FontString:SetPoint("BOTTOM", frame, "BOTTOM", 90, 60)
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("RIGHT", NecrosisButtonsConfig1, "BOTTOMRIGHT", -10,-5)
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 10,-5)
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("RIGHT", NecrosisButtonsConfig2, "BOTTOMRIGHT", -10,-5)
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig2, "BOTTOMLEFT", 10,-5)
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 193, 400)
	...
	for i in ipairs(boutons_pierres) do
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 188, initY_pierres - (25 * (i - 1)))
		if i == 1 then
	...
	-- Position header "Boutons Pierres" relative to first checkbox text
		...
		headerPierres:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 217, 365)
	...
	for i in ipairs(boutons_action) do
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 188, initY_action - (25 * (i - 1)))
		if i == 1 then
	...
	-- Position header "Boutons d'Action" relative to first checkbox text
		...
		headerAction:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 217, 230)
