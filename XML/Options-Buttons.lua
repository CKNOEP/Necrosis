...
function Necrosis:SetButtonsConfig()
	...
	if not frame then
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", -10, 390)
	...
	for i in ipairs(boutons_pierres) do
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", -10, initY_pierres - (25 * (i - 1)))
		if i == 1 then
	...
	-- Position header "Boutons Pierres" relative to first checkbox text
		...
		headerPierres:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 19, 365)
	...
	for i in ipairs(boutons_action) do
		...
		frame:Show()
		frame:ClearAllPoints()
		frame:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", -10, initY_action - (25 * (i - 1)))
		if i == 1 then
	...
	-- Position header "Boutons d'Action" relative to first checkbox text
		...
		headerAction:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 19, 230)
