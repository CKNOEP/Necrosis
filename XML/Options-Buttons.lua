...
function Necrosis:SetButtonsConfig()
	...
	-- Position header "Boutons Pierres" relative to first checkbox text
		...
		headerPierres:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 49, 365)
	...
	-- Position header "Boutons d'Action" relative to first checkbox text
		...
		headerAction:SetPoint("LEFT", NecrosisButtonsConfig1, "BOTTOMLEFT", 49, 230)
	...
	-- Sub Menu 2
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton1", NecrosisButtonsConfig2)
		frame:SetID("1")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton2", NecrosisButtonsConfig2)
		frame:SetID("2")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton3", NecrosisButtonsConfig2)
		frame:SetID("3")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton4", NecrosisButtonsConfig2)
		frame:SetID("4")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton5", NecrosisButtonsConfig2)
		frame:SetID("5")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton6", NecrosisButtonsConfig2)
		frame:SetID("6")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton7", NecrosisButtonsConfig2)
		frame:SetID("7")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton8", NecrosisButtonsConfig2)
		frame:SetID("8")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton9", NecrosisButtonsConfig2)
		frame:SetID("9")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton10", NecrosisButtonsConfig2)
		frame:SetID("10")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton11", NecrosisButtonsConfig2)
		frame:SetID("11")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
		...
		frame = CreateFrame("CheckButton", "NecrosisCompanionButton12", NecrosisButtonsConfig2)
		frame:SetID("12")
		frame:EnableMouse(true)
		frame:Show()
		frame:ClearAllPoints()
