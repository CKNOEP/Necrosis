...
-- RETAIL VERSION (Midnight 12.0+)
-- Removed spells: Soul Link [19028], Detect Invisibility [132]
-- See Spells-Midnight.lua for spell ID changes
...
--]]
	...
	-- ["Invisible"] = { -- RETAIL: Detect Invisibility [132] removed in Midnight
	--	Label = ""
	-- },
	["Kilrogg"] = {
		Label = ""
	...
	-- ["SoulLink"] = { -- RETAIL: Soul Link [19028] removed in Midnight
	--	Label = ""
	-- },
	["ShadowProtection"] = {
		Label = ""
...
Necrosis.Config.Sphere.CountType = {
	L["SOUL_SHARDS"],
	L["DEMON_SUMMON_STONES"],
	L["REZ_TIMER"],
	L["HEALTH"],
